...
recurs_times = [get_time_of_exec(recurs_alg, i)[1] for i in calc_range]
...
plt.legend(loc='upper left', fontsize='medium') # Добавление легенды
